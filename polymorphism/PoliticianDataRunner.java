class PoliticianDataRunner{

   public static void main(String[] acheDinAyenge)
{
   PoliticianData.PoliticianData1("Modi");
   PoliticianData.PoliticianData1("Atal bihari vajpe"); 
